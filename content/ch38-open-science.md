...
## Preprint 전략의 실전 — 박사 논문 공개 타이밍과 위험 관리

Preprint(동료심사 전 논문 공개)는 박사 연구의 핵심 전략 도구다. 2024-2026년 현재 AI·물리·수학 분야에서는 **논문을 arXiv에 올리지 않으면 존재하지 않는 것**으로 간주되는 경향. 하지만 preprint에는 장점만 있는 것이 아니다. 잘못 쓰면 scooping 위험, 리뷰어의 편향, 실수의 영구 기록 같은 함정. 이 섹션은 박사가 preprint를 전략적으로 활용하는 실전 가이드를 다룬다. ch38의 앞부분은 오픈 사이언스의 일반 원칙을 다뤘다면, 이 섹션은 **preprint의 전략적 의사결정**을 구체적으로 다룬다.

**Preprint의 5가지 가치 — 왜 박사가 올려야 하는가.**

많은 박사가 "출판된 논문만 진짜"라고 생각한다. 실제로 2024-2026년 preprint의 가치:

**가치 1, 우선권 확보 (Priority)**: 공개 timestamp가 분야 최초의 증거. 누군가 유사 연구를 6개월 후 출판해도 본인의 preprint가 앞선다. AI 분야에서는 이 가치가 압도적. 같은 아이디어가 1-2주 차이로 여러 연구실에서 나오는 것이 일상.

**가치 2, 조기 피드백**: 동료심사 (4-12개월)를 기다리지 않고 전 세계 독자의 피드백. 이메일 수십 통, Twitter/X 토론, PubPeer 댓글. 본격 심사 전에 논문 품질 향상 기회.

**가치 3, 인용 시작**: 출판 전부터 인용됨. 2024년 기준 일부 분야에서 논문의 인용 50% 이상이 preprint 단계에서 발생. 박사의 학술 영향력이 1-2년 빨라짐.

**가치 4, 임용·포닥 지원의 증거**: 임용 지원 시점에 출판된 논문만으로는 부족. preprint가 "in progress"의 공식 증거. 임용위원회도 점점 preprint를 평가 자료로 수용.

**가치 5, 대중·산업에의 노출**: 페이월 없이 누구나 접근. 산업계 엔지니어, 기자, 정책 담당자가 본인 연구를 읽음. 이것이 협업·일자리·영향의 원천.

**Preprint의 3가지 위험 — 균형 있는 시각.**

가치만 보면 무조건 올려야 할 것 같다. 실제로는 위험도 있다:

**위험 1, Scooping의 역설**: 본인의 아이디어를 공개함으로써 경쟁자가 빠르게 추격 가능. "내 아이디어를 공개하는 것이 우선권인가 아니면 경쟁자에게 선물인가?" 이 균형이 박사의 판단. 경쟁적 분야(AI, 의학)에서는 빠른 preprint가 유리, 느린 분야(수학, 역사)에서는 완성도 우선.

**위험 2, 실수의 영구 기록**: Preprint에 올린 오류는 영구히 남는다. v2, v3으로 수정해도 v1의 존재는 사라지지 않음. 신중한 박사는 **preprint 올리기 전 공동저자·지도교수의 최종 검토**.

**위험 3, 특정 저널의 preprint 정책**: 대부분의 저널은 preprint를 허용하지만, 일부 의학·임상 저널은 preprint 후 심사 거부. 투고 계획 저널의 정책 사전 확인 필수.

**분야별 Preprint 서버 지도 — 박사의 선택.**

2024-2026년 주요 preprint 서버:

- **arXiv** (1991-): 물리·수학·CS·통계·생명과학·경제학. 박사 CS/AI/물리의 필수. 연 약 20만 편.
- **bioRxiv** (2013-): 생명과학·의학. Cold Spring Harbor Lab 운영.
- **medRxiv** (2019-): 의학·임상. bioRxiv의 형제.
- **ChemRxiv** (2017-): 화학. ACS 운영.
- **engrXiv** (2016-): 공학 전반.
- **TechRxiv** (2020-): IEEE 운영, 공학·기술.
- **SocArXiv** (2016-): 사회과학.
- **EarthArXiv** (2017-): 지구과학.
- **PsyArXiv** (2016-): 심리학.
- **OSF Preprints** (OSF 운영): 다양한 분야.

본인 분야의 주류 서버에 올리는 것이 원칙. 다중 서버에 올리면 혼란. 예: CS 박사 → arXiv, 생명과학 박사 → bioRxiv.

**Preprint 타이밍의 5가지 전략.**

언제 올릴 것인가? 박사의 전략적 의사결정:

**전략 1, 저널 투고와 동시**: 가장 일반적. 저널에 제출하는 날 preprint도 올림. 우선권 확보 + 리뷰 병행. 2024년 기준 AI 분야의 표준.

**전략 2, 저널 투고 1-2주 전**: 공개 피드백을 받은 후 저널 투고. 품질이 한 번 더 올라감. 하지만 scooping 위험 약간.

**전략 3, 저널 1차 심사 통과 후**: Major revision을 받은 후 preprint. 안전하지만 늦음. 우선권 효과가 약함.

**전략 4, 학회 발표 시점**: 학회에 받아들여진 논문을 발표 시점에 preprint. 학회 버전과 저널 버전을 구분.

**전략 5, 학회 투고 시점 (double-blind 학회)**: NeurIPS, ICLR 등 double-blind 학회는 preprint 시기에 주의. 일반적으로 preprint 후 저자 정보 공개는 문제 없지만, 리뷰 기간 중 social media 홍보는 금지.

**박사의 권장 전략**: 박사 1-2년차는 **전략 3** (안전 우선). 박사 3년차 이후는 **전략 1** (속도 우선). 이 전환의 타이밍이 박사 preprint 활용의 숙련도를 보여줌.

**Preprint 버전 관리 — v1에서 v_final까지.**

Preprint는 여러 번 업데이트된다. 버전 관리의 실전:

- **v1**: 최초 공개. 가장 많은 주목. 실수 최소화 노력.
- **v2**: 피드백 반영. 보통 1-3개월 후. 변경사항을 preprint 페이지의 "Changes" 섹션에 명시.
- **v3-v_final**: 저널 심사 후 수정. 각 버전마다 변경사항 기록.
- **출판 후**: 최종 출판 버전의 DOI를 preprint 페이지에 추가. 독자가 최신 버전을 찾을 수 있게.

arXiv의 경우 **같은 논문의 모든 버전이 보존**. v1의 오류가 v2에서 수정돼도 v1은 계속 접근 가능. 이것이 장단점의 양면.

**Scooping 방어 — 빠른 연구에서 본인을 지키는 법.**

본인이 6개월 연구한 주제를 누군가 먼저 preprint로 올리는 상황. 방어 전략:

- **조기 preprint**: 본인이 주도권을 가지고 있다면 가능한 빨리 preprint. "연구가 완벽하지 않아도 올린다"는 결단.
- **동시 공개**: 유사 연구 발견 시 급하게 본인 preprint 올려 동시 공개. 둘 다 independent work로 인정받음.
- **Scoop된 경우**: 본인의 contribution이 경쟁자와 다르다면 그 차이를 명확히 한 별도 preprint. "Our work extends/complements Smith et al., 2024 in that..."
- **완전 scoop**: 경쟁자가 본인보다 모든 면에서 앞선 경우. 박사의 방향 전환 필요. ch32(멘탈 헬스) 참조.

**Preprint의 피드백 처리 기술.**

Preprint를 올리면 이메일·Twitter·PubPeer로 피드백이 온다. 처리 기술:

- **정중한 응답**: 모든 피드백에 답장. "Thank you for your comment. We agree/respectfully disagree because..." 공개 플랫폼의 톤이 본인 학자 브랜드.
- **기술적 오류 즉시 인정**: "You are correct. We have fixed this in v2. Thank you for pointing it out."
- **철학적 반대는 토론**: "Our perspective differs because..." 공개적으로 건설적 토론.
- **악의적 공격 무시**: Twitter의 비건설적 비난은 답하지 말고 무시. 학술적 피드백만 응답.
- **피드백을 revision에 반영**: 의미 있는 피드백은 논문 수정에 활용. "We thank [Name] for noting that..."

**한국 박사의 Preprint 활용 현실.**

한국 박사의 preprint 활용은 해외보다 낮은 편. 원인과 극복:

- **"불완전한 연구를 공개하는 불편함"**: 한국 학계의 완벽주의 문화. 극복: preprint는 "완벽한 논문"이 아니라 "진행 중 연구"의 기록. 틀려도 괜찮다.
- **저작권·IP 우려**: "내 아이디어를 빼앗기면?" 실제로 공개된 preprint는 우선권의 증거. 반대로 공개 안 하면 증거 없음.
- **지도교수의 보수적 태도**: 일부 한국 지도교수는 preprint에 반대. 이 경우 저널 1차 심사 통과 후 preprint 같은 절충.
- **한국어 preprint**: 2024-2026년 일부 국내 학회가 한국어 preprint 서버 운영. 하지만 국제 영향력 제한적. 영어 preprint를 권장.

**AI 시대의 Preprint 변화 — 2024-2026 동향.**

AI 분야 preprint의 최근 변화:

- **속도 가속**: arXiv의 AI/ML 분야 preprint가 2023년 이후 폭증. 매일 수백 편. 개별 논문의 주목 시간이 짧음. 첫 48시간의 Twitter/X 홍보가 결정적.
- **LLM-generated preprint의 우려**: 2024-2025년 사이 AI로 양산된 낮은 품질 preprint 증가. arXiv moderation team의 부하. 고품질 preprint의 차별화가 더 중요해짐.
- **Papers With Code 통합**: preprint + code + leaderboard 통합 공개가 AI 분야 표준. 코드 없이 preprint만 올리면 주목받지 못함.
- **Twitter/X alerts**: 본인 분야의 새 preprint를 Twitter/X에서 빠르게 확인. "arXiv-sanity" 같은 도구 활용.
- **한국어 AI Preprint**: KoAlpaca, HyperCLOVA X 같은 한국어 LLM 관련 preprint가 한국 박사의 기회.

**마지막 — Preprint는 박사 연구 속도의 핵심 레버다.**

박사 5-7년 동안 10-20편의 논문을 쓴다면, 각 논문의 preprint 전략이 박사 전체 영향력을 결정한다. 5가지 가치(우선권·피드백·인용·임용 증거·대중 노출)와 3가지 위험(scooping·실수 영구 기록·저널 정책)의 균형, 분야별 서버 선택, 5가지 타이밍 전략, 버전 관리, scooping 방어, 피드백 처리, AI 시대의 속도 변화 — 이 모든 것을 의식적으로 관리하는 박사가 같은 연구 품질에서 2-3배 더 큰 영향력을 얻는다. 박사 3년차부터 preprint를 전략적으로 활용하는 것이 2024-2026년의 표준이다.

> Preprint는 박사 연구 속도의 핵심 레버다. 5가지 가치(우선권·피드백·인용·임용·대중)와 3가지 위험(scooping·실수 영구 기록·저널 정책)의 균형. 분야별 서버(arXiv·bioRxiv·engrXiv·TechRxiv 등) 중 주류 선택. 5가지 타이밍 전략에서 박사 3년차+는 저널 투고와 동시. 버전 관리(v1~v_final)와 scooping 방어의 실전. AI 시대 Papers With Code 통합과 Twitter/X 홍보. 한국 박사의 완벽주의·보수성 극복. Preprint 전략이 박사 영향력의 2-3배 레버다.

---

## 등록된 보고서(Registered Reports) — 사전 등록의 강력한 확장

ch38의 앞부분이 preprint와 데이터/코드 공개를 다뤘다면, 이 섹션은 오픈 사이언스의 더 급진적 형태인 **Registered Reports**를 다룬다. 2013년 *Cortex* 저널이 도입한 후 2024년 현재 200+ 저널이 채택 중인 이 새로운 출판 모델은 **박사의 출판 전략을 근본적으로 바꿀 수 있다**. 많은 한국 박사가 이 옵션을 모르거나 과소평가한다. 이 섹션은 박사의 Registered Reports 실전을 다룬다.

**Registered Reports란 무엇인가.**

전통적 출판 모델의 문제: 연구 설계 → 실험 → 분석 → 논문 → 투고 → 심사 → 출판. 심사는 마지막 단계. 결과가 "흥미로우면" accept, 아니면 reject. 이것이 **publication bias**의 원인.

Registered Reports의 다른 구조:

1. **Stage 1 (설계 단계)**: 연구 질문, 가설, 방법론, 통계 계획을 **실험 전에** 저널에 제출.
2. **Stage 1 Review**: 리뷰어가 설계·방법론 심사. 이 단계에서 in-principle acceptance (IPA) 결정.
3. **실험 실행**: IPA 받은 후 등록된 프로토콜대로 실험.
4. **Stage 2 제출**: 결과 + 분석.
5. **Stage 2 Review**: 결과의 해석 심사. 결과가 긍정이든 부정이든 출판 보장 (프로토콜 준수 시).

핵심: **결과의 방향이 아닌 질문의 중요성과 방법의 엄밀성으로 심사**.

**Registered Reports의 5가지 이점.**

**이점 1, Publication bias 해소**: 부정 결과도 출판. "실패한 연구" 의 가치 회복.

**이점 2, 사전 피드백의 가치**: Stage 1에서 실험 설계에 대한 피어 리뷰. 실험 **시작 전에** 수정. 시간 절약.

**이점 3, P-hacking 방지**: 통계 계획 사전 등록. 데이터 보고 선택적 분석 불가. 연구 무결성.

**이점 4, 박사 프로젝트의 안정성**: 결과에 관계없이 출판 보장 (프로토콜 준수 시). 박사 졸업의 리스크 감소.

**이점 5, 연구의 품질 향상**: 설계 단계에서 전문가 피드백. 더 엄밀한 연구.

**박사에게 Registered Reports의 특별한 가치.**

박사 학생이 RR을 적극 활용해야 할 이유:

- **박사 졸업의 확실성**: 논문이 없으면 박사 졸업 어려움. RR은 결과 무관 출판 보장.
- **시간 절약**: 실험 후 reject는 큰 손실. 사전 심사로 방향 확인.
- **박사 논문의 엄밀성**: 엄격한 방법론으로 학위논문 강화.
- **임용 시장의 신호**: RR 경험이 방법론적 엄격성의 증거.
- **개방성 학계 기여**: 오픈 사이언스의 선도자로 자리매김.

박사 2-3년차의 주요 프로젝트를 RR로 진행하는 것을 진지하게 고려.

**Registered Reports를 받는 주요 저널 — 분야별.**
...
전체 목록: Center for Open Science (COS)의 "Registered Reports" 페이지. 분기별 업데이트.

**박사의 RR 투고 타임라인.**

전통 출판보다 약간 다른 타임라인:

- **월 0**: 연구 아이디어 확정. 지도교수와 RR 가능성 논의.
- **월 1-3**: Stage 1 원고 작성. 문헌, 가설, 방법, 통계 계획 상세.
- **월 3**: Stage 1 투고.
- **월 4-7**: Stage 1 리뷰·수정. 1-2라운드.
- **월 7**: In-Principle Acceptance (IPA) 수령.
- **월 7-15**: 실험 실행. 프로토콜 엄격 준수.
- **월 15-18**: 분석·Stage 2 원고 작성.
- **월 18**: Stage 2 투고.
- **월 18-22**: Stage 2 리뷰·수정.
- **월 22-24**: 출판.

전체 2년. 전통 모델과 비슷하지만 **결과 무관 출판 확률**이 훨씬 높음.

**RR의 3가지 실전 도전.**

**도전 1, 방법론의 사전 고정**: 실험 시작 후 방법 변경 제약. 탐색적 요소 제약. 대응: "사전 등록된 confirmatory + 탐색적 분석" 병행.

**도전 2, 저널 선택의 제약**: RR을 받는 저널이 제한적. 본인 분야에 적합한 저널이 없을 수 있음. 대응: COS 목록 정기 확인.

**도전 3, 실험의 유연성 감소**: 예상치 못한 이슈에 대응 어려움. 대응: Stage 1에서 "if-then" 시나리오 사전 명시.

**RR + 다른 오픈 사이언스의 결합.**

RR은 다른 오픈 사이언스와 시너지:

- **RR + Preprint**: Stage 1을 preprint로 공개. 더 빠른 피드백.
- **RR + Open Data**: 사전 등록된 데이터 수집 계획. 공개 시 투명성.
- **RR + Open Code**: 분석 스크립트 사전 등록 + Stage 2에 공개.
- **RR + Replication**: 기존 연구의 엄격한 복제를 RR로. 과학의 복제 위기 대응.

**한국 박사의 RR 채택 현실.**

- **인지도 낮음**: 한국 학계에서 RR 인지도 아직 낮음. 2024-2026년 증가 중.
- **지도교수 동의**: RR 경험 있는 지도교수 드뭄. 설득 필요.
- **분야 격차**: 심리학 등은 RR 활발, 공학은 적음.
- **한국 저널**: 한국 저널에서 RR 거의 없음. 국제 저널 중심.
- **기회**: 한국 박사의 RR 투고는 상대적 희소성으로 눈에 띔.

**AI 시대의 RR — 2024+.**

AI가 RR에 미치는 영향:

- **Stage 1의 AI 보조**: 방법론 설계, 통계 계획에 LLM 활용. 단, 본인 사고가 주.
- **AI 재현성**: AI 사용 시 seed·모델 버전·프롬프트를 Stage 1에 사전 등록.
- **RR이 AI hype 방어**: AI로 양산되는 낮은 품질 논문에 대응. 방법론 엄격성 회복.
- **AI Registered Reports**: 일부 AI 학회가 RR 실험 중 (NeurIPS Datasets and Benchmarks Track 등).

**RR의 한계와 비판.**

RR이 만능은 아님:

- **탐색적 연구에 부적합**: 완전 열린 탐색은 RR 구조와 맞지 않음.
- **시간 투자 큼**: Stage 1에 수개월. 빠른 연구에는 부담.
- **저널 제한**: 본인 분야 top venue가 RR을 안 받을 수 있음.
- **리뷰어의 보수성**: Stage 1 리뷰가 과도하게 엄격한 경우.
- **분야 문화**: 공학·물리는 아직 덜 친숙.

이런 한계를 알고 선택적 활용.

**마지막 — Registered Reports는 박사 출판 전략의 선택지다.**
