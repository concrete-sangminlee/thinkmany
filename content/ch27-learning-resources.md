...
## 박사의 학습 일지 — 배운 것의 기록과 재활성화

박사 5-7년 동안 **엄청난 양을 배운다**. 책·논문·강의·세미나·미팅·실험. 하지만 6개월 후 본인이 배운 것의 **10%도 기억 못함**. 이것이 당연하지만, **학습 일지**가 이 손실을 50-70% 회복. 이 섹션은 박사가 학습 일지를 체계적으로 쓰고 활용하는 실전을 다룬다. ch27의 다른 섹션(교과서·LLM 튜터·체화·강의 완주)이 **학습 활동**이었다면, 이 섹션은 **학습의 기록·재활성화**다.
...
**5년간 수천 노트**가 본인의 지식 그래프.

**Spaced Repetition의 활용.**

에빙하우스 망각 곡선:

**방법**:
- 1일·3일·1주·2주·1개월 후 재독.
- 각 재독에서 간격 늘림.
...
- **Related Work**: 학습 일지의 논문 요약 활용.
- **Introduction**: 배경 지식의 축적.
- **Discussion**: 본인 연결 아이디어.

**박사 1-5년의 일지**가 **학위논문의 기초**.
...
**박사 과정의 수십 아이디어** 중 몇 개가 논문·박사 주제.
...
**함정 1, 완벽주의**: 완벽한 노트. 쓰지 못함.

**함정 2, 양 추구**: 많이 쓰지만 활용 없음.

**함정 3, 리뷰 부재**: 쓰기만 하고 재독 X.
...
**마지막 — 학습 일지는 박사의 두 번째 뇌다.**

배운 것의 90%가 사라지는 것을 막는 유일한 방법. 5가지 목적·기본 형식·3가지 스타일·Zettelkasten·Spaced Repetition·주간·월간 리뷰·논문 연결·디지털 도구·4가지 콘텐츠·질문·아이디어·Reading→Writing·시간·5가지 함정·장기 자산·AI 시대·한국 맥락·5가지 팁·복리 — 이 모든 것을 박사 1년차부터 시작하면 5년 후 본인이 **지식의 주인**. 기록하지 않은 학습은 사라진다.

> 학습 일지는 박사의 두 번째 뇌. 5가지 목적 (기억·연결·이해·미래 전달·논문 원료). 일기식·주제식·혼합 스타일. Zettelkasten 1-note-1-idea. Spaced Repetition (Anki·에빙하우스). 주간·월간 리뷰. 학위논문의 Related Work 기초. Obsidian+Anki 도구. 4가지 콘텐츠 (개념·논문·질문·아이디어). 질문 노트가 박사 후 연구 씨앗. Reading → Writing 원칙. 주 3-5시간 투자. 5가지 함정 (완벽·양·리뷰 부재·도구·분산). 2024+ AI는 보조. 한국어/영어 선택. 5년 복리. 기록하지 않은 학습은 사라진다.
